...
Save the rendered report to `docs/codebase/SECURITY.md` within the scanned repository
(create the `docs/codebase/` directory if missing). Overwrite any existing file at that
path. Also render the report inline in the chat response.
